...
namespace Ignite_LinQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            listEmployee[0] = new Employee(1, "Employee2", "22222222B");
            listEmployee[0] = new Employee(1, "Employee3", "33333333C");
            listEmployee[0] = new Employee(1, "Employee4", "44444444D");
